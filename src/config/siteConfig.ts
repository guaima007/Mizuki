...
export const siteConfig: SiteConfig = {
	title: "領域展開",
	subtitle: "呪術廻戦 · 术式的尽头是觉悟",
	siteURL: "https://your-domain.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-05-24", // 站点开始运行日期，用于站点统计组件计算运行天数

	lang: SITE_LANG,

	themeColor: {
		hue: 275, // 主题色的默认色相，咒术回战主题紫（咒力色）
	...
	banner: {
		...
		credit: {
			...
			text: "呪術廻戦 © 芥見下々 / 集英社", // 要显示的来源文本
			url: "https://jujutsukaisen.jp/", // （可选）原始艺术品或艺术家页面的 URL 链接
		},
